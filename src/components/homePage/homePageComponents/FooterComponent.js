...
export default () => (
    <div className="footer">
        <div className="row">
            ...
            <div className="col-sm-4">
                <h5>
                    Puslapyje naudojama: ReactJS, Material-UI, Bootsrap v4. Pravartu paminėti, jog buvo naudojamas "destructuring".
                </h5>
            </div>
            <div className="col-sm-4">
            <div className="btn-group" role="group">
                <SocialIcon url="http://facebook.com/mldc14" color="#E8630C" />
